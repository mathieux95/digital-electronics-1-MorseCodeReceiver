...
| `Edge detector`| receiving binary input - [0] and [1] - from push button `BTNU` and differentiates between `rising_edge` or `falling_edge`. <br />If detector receives either rising_edge or falling_edge binary 1 is sent to output.                                                                                                             |
|:-------------------------------------	|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------	|
